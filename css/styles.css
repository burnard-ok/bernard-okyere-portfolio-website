...
:root {
  --engineer-bg: #e0eaff; /* More visible light blue for engineer background */
  --engineer-primary: #212529; /* Dark gray for engineer text */
  --engineer-secondary: #495057; /* Muted gray for secondary text */
}

.bg-engineer {
  background-color: var(--engineer-bg) !important;
}

.text-engineer-primary {
  color: var(--engineer-primary) !important;
}

.text-engineer-secondary {
  color: var(--engineer-secondary) !important;
}
...
/* --- Master Global Typography Override --- */
...
/* --- Form Input Typography Polish --- */
.form-control, .form-control::placeholder, label {
    font-family: "Plus Jakarta Sans", sans-serif !important;
    color: #212529 !important; /* Forces typed input text to be fully readable and dark */
}
/* --- Site dark mode --- */
html[data-theme="dark"] {
  --engineer-bg: #0b1220;
  --engineer-primary: #f8fafc;
  --engineer-secondary: #cbd5e1;
  --bs-body-bg: #0b1220;
...
html[data-theme="dark"] .bg-engineer {
...
html[data-theme="dark"] .text-engineer-primary {
  color: #f8fafc !important;
}

html[data-theme="dark"] .text-engineer-secondary {
  color: #cbd5e1 !important;
}
...
/* --- Engineering palette for the home page --- */
.engineer-page .navbar-brand {
  color: #0d3b66 !important;
  font-weight: 800;
}

.engineer-page .text-engineer-kicker,
.resume-page .text-engineer-kicker {
  color: #315a7d;
  letter-spacing: 0.08em;
}

.engineer-page .text-gradient {
  background: none;
...
.engineer-page .text-muted {
  color: #516b82 !important;
}

.engineer-page .bg-gradient-primary-to-secondary {
  background: #0d3b66;
  background: linear-gradient(135deg, #0d3b66 0%, #1f6f8b 100%);
}

.engineer-page .btn-outline-dark {
  color: #163a59;
  border-color: #163a59;
}

.engineer-page .btn-outline-dark:hover {
  background-color: #163a59;
  border-color: #163a59;
}

html[data-theme="dark"] .engineer-page .navbar-brand,
html[data-theme="dark"] .engineer-page .text-gradient {
  color: #7dd3fc !important;
}

html[data-theme="dark"] .engineer-page .text-engineer-kicker,
html[data-theme="dark"] .resume-page .text-engineer-kicker,
html[data-theme="dark"] .engineer-page .text-muted {
  color: #b6d5e5 !important;
}

html[data-theme="dark"] .engineer-page .btn-outline-dark {
  color: #dbeafe;
  border-color: #93c5fd;
}

html[data-theme="dark"] .engineer-page .btn-outline-dark:hover {
  background-color: #1d4f72;
  border-color: #1d4f72;
}

/* Keep navigation branding consistent across the core pages. */
.engineer-page .navbar-brand .text-primary,
.resume-page .navbar-brand .text-primary {
  color: #0d3b66 !important;
  font-size: inherit;
  font-weight: 700 !important;
}

.engineer-page .text-engineer-primary,
.resume-page .text-engineer-primary {
  color: #0d3b66 !important;
}

html[data-theme="dark"] .engineer-page .navbar-brand .text-primary,
html[data-theme="dark"] .resume-page .navbar-brand .text-primary {
  color: #7dd3fc !important;
}

html[data-theme="dark"] .engineer-page .text-engineer-primary,
html[data-theme="dark"] .resume-page .text-engineer-primary {
  color: #7dd3fc !important;
}

/* Home-page expertise and publication highlights. */
.hero-focus > .col > div {
  height: 100%;
  padding: 0.65rem;
...
html[data-theme="dark"] .hero-focus > .col > div {
  border-color: #3b5570;
  background: #17263a;
  color: #dbeafe;
}

html[data-theme="dark"] .hero-focus i,
html[data-theme="dark"] .hero-credentials span::before {
  color: #7dd3fc;
}

html[data-theme="dark"] .hero-credentials {
  color: #b6d5e5;
}
...
html[data-theme="dark"] .project-tech-stack span {
  border-color: #3b5570;
  background: #17263a;
  color: #dbeafe;
}
...
/* Shared logo and wordmark used across every page. */
.site-brand {
  display: inline-flex;
  align-items: center;
  gap: 0.7rem;
...
html[data-theme="dark"] .zoom-controls button:hover:not(:disabled) {
  background: #e2e8f0;
}
...
.privacy-modal-card p:last-child {
  margin-bottom: 0;
}
...
html[data-theme="dark"] .privacy-modal-close {
  color: #e2e8f0;
}

html[data-theme="dark"] .privacy-modal-close:hover {
  background: #334155;
}
